...
public class ToolMaterials {
    ...
    public static ToolMaterial WOOD_BLAZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, WOOD_BASE_USES + BLAZE_USES, WOOD_BASE_SPEED + BLAZE_SPEED, WOOD_BASE_DMG + BLAZE_DMG, WOOD_BASE_ENCH + BLAZE_ENCH, ItemTags.WOODEN_TOOL_MATERIALS);
    ...
    public static ToolMaterial WOOD_END_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, WOOD_BASE_USES + END_USES, WOOD_BASE_SPEED + END_SPEED, WOOD_BASE_DMG + END_DMG, WOOD_BASE_ENCH + END_ENCH, ItemTags.WOODEN_TOOL_MATERIALS);
    ...
    public static ToolMaterial WOOD_BREEZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, WOOD_BASE_USES + BREEZE_USES, WOOD_BASE_SPEED + BREEZE_SPEED, WOOD_BASE_DMG + BREEZE_DMG, WOOD_BASE_ENCH + BREEZE_ENCH, ItemTags.WOODEN_TOOL_MATERIALS);
    ...
    public static ToolMaterial WOOD_CERTUSQUARTZ_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, WOOD_BASE_USES + CERTUSQUARTZ_USES, WOOD_BASE_SPEED + CERTUSQUARTZ_SPEED, WOOD_BASE_DMG + CERTUSQUARTZ_DMG, WOOD_BASE_ENCH + CERTUSQUARTZ_ENCH, ItemTags.WOODEN_TOOL_MATERIALS);
    ...
    public static ToolMaterial WOOD_COBALT_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, WOOD_BASE_USES + COBALT_USES, WOOD_BASE_SPEED + COBALT_SPEED, WOOD_BASE_DMG + COBALT_DMG, WOOD_BASE_ENCH + COBALT_ENCH, ItemTags.WOODEN_TOOL_MATERIALS);
    public static ToolMaterial WOOD_TITANIUM_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, WOOD_BASE_USES + TITANIUM_USES, WOOD_BASE_SPEED + TITANIUM_SPEED, WOOD_BASE_DMG + TITANIUM_DMG, WOOD_BASE_ENCH + TITANIUM_ENCH, ItemTags.WOODEN_TOOL_MATERIALS);
    public static ToolMaterial WOOD_ZINC_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, WOOD_BASE_USES + ZINC_USES, WOOD_BASE_SPEED + ZINC_SPEED, WOOD_BASE_DMG + ZINC_DMG, WOOD_BASE_ENCH + ZINC_ENCH, ItemTags.WOODEN_TOOL_MATERIALS);
    ...
    public static ToolMaterial STONE_BLAZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, STONE_BASE_USES + BLAZE_USES, STONE_BASE_SPEED + BLAZE_SPEED, STONE_BASE_DMG + BLAZE_DMG, STONE_BASE_ENCH + BLAZE_ENCH, ItemTags.STONE_TOOL_MATERIALS);
    ...
    public static ToolMaterial STONE_END_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, STONE_BASE_USES + END_USES, STONE_BASE_SPEED + END_SPEED, STONE_BASE_DMG + END_DMG, STONE_BASE_ENCH + END_ENCH, ItemTags.STONE_TOOL_MATERIALS);
    ...
    public static ToolMaterial STONE_BREEZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, STONE_BASE_USES + BREEZE_USES, STONE_BASE_SPEED + BREEZE_SPEED, STONE_BASE_DMG + BREEZE_DMG, STONE_BASE_ENCH + BREEZE_ENCH, ItemTags.STONE_TOOL_MATERIALS);
    ...
    public static ToolMaterial STONE_CERTUSQUARTZ_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, STONE_BASE_USES + CERTUSQUARTZ_USES, STONE_BASE_SPEED + CERTUSQUARTZ_SPEED, STONE_BASE_DMG + CERTUSQUARTZ_DMG, STONE_BASE_ENCH + CERTUSQUARTZ_ENCH, ItemTags.STONE_TOOL_MATERIALS);
    ...
    public static ToolMaterial STONE_COBALT_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, STONE_BASE_USES + COBALT_USES, STONE_BASE_SPEED + COBALT_SPEED, STONE_BASE_DMG + COBALT_DMG, STONE_BASE_ENCH + COBALT_ENCH, ItemTags.STONE_TOOL_MATERIALS);
    public static ToolMaterial STONE_TITANIUM_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, STONE_BASE_USES + TITANIUM_USES, STONE_BASE_SPEED + TITANIUM_SPEED, STONE_BASE_DMG + TITANIUM_DMG, STONE_BASE_ENCH + TITANIUM_ENCH, ItemTags.STONE_TOOL_MATERIALS);
    public static ToolMaterial STONE_ZINC_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, STONE_BASE_USES + ZINC_USES, STONE_BASE_SPEED + ZINC_SPEED, STONE_BASE_DMG + ZINC_DMG, STONE_BASE_ENCH + ZINC_ENCH, ItemTags.STONE_TOOL_MATERIALS);
    ...
    public static ToolMaterial IRON_BLAZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, IRON_BASE_USES + BLAZE_USES, IRON_BASE_SPEED + BLAZE_SPEED, IRON_BASE_DMG + BLAZE_DMG, IRON_BASE_ENCH + BLAZE_ENCH, Tags.Items.INGOTS_IRON);
    ...
    public static ToolMaterial IRON_END_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, IRON_BASE_USES + END_USES, IRON_BASE_SPEED + END_SPEED, IRON_BASE_DMG + END_DMG, IRON_BASE_ENCH + END_ENCH, Tags.Items.INGOTS_IRON);
    ...
    public static ToolMaterial IRON_BREEZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, IRON_BASE_USES + BREEZE_USES, IRON_BASE_SPEED + BREEZE_SPEED, IRON_BASE_DMG + BREEZE_DMG, IRON_BASE_ENCH + BREEZE_ENCH, Tags.Items.INGOTS_IRON);
    ...
    public static ToolMaterial IRON_CERTUSQUARTZ_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, IRON_BASE_USES + CERTUSQUARTZ_USES, IRON_BASE_SPEED + CERTUSQUARTZ_SPEED, IRON_BASE_DMG + CERTUSQUARTZ_DMG, IRON_BASE_ENCH + CERTUSQUARTZ_ENCH, Tags.Items.INGOTS_IRON);
    ...
    public static ToolMaterial IRON_COBALT_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, IRON_BASE_USES + COBALT_USES, IRON_BASE_SPEED + COBALT_SPEED, IRON_BASE_DMG + COBALT_DMG, IRON_BASE_ENCH + COBALT_ENCH, Tags.Items.INGOTS_IRON);
    public static ToolMaterial IRON_TITANIUM_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, IRON_BASE_USES + TITANIUM_USES, IRON_BASE_SPEED + TITANIUM_SPEED, IRON_BASE_DMG + TITANIUM_DMG, IRON_BASE_ENCH + TITANIUM_ENCH, Tags.Items.INGOTS_IRON);
    public static ToolMaterial IRON_ZINC_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, IRON_BASE_USES + ZINC_USES, IRON_BASE_SPEED + ZINC_SPEED, IRON_BASE_DMG + ZINC_DMG, IRON_BASE_ENCH + ZINC_ENCH, Tags.Items.INGOTS_IRON);
    ...
    public static ToolMaterial GOLD_BLAZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL, GOLD_BASE_USES + BLAZE_USES, GOLD_BASE_SPEED + BLAZE_SPEED, GOLD_BASE_DMG + BLAZE_DMG, GOLD_BASE_ENCH + BLAZE_ENCH, Tags.Items.INGOTS_GOLD);
    ...
    public static ToolMaterial GOLD_END_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL, GOLD_BASE_USES + END_USES, GOLD_BASE_SPEED + END_SPEED, GOLD_BASE_DMG + END_DMG, GOLD_BASE_ENCH + END_ENCH, Tags.Items.INGOTS_GOLD);
    ...
    public static ToolMaterial GOLD_BREEZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL, GOLD_BASE_USES + BREEZE_USES, GOLD_BASE_SPEED + BREEZE_SPEED, GOLD_BASE_DMG + BREEZE_DMG, GOLD_BASE_ENCH + BREEZE_ENCH, Tags.Items.INGOTS_GOLD);
    ...
    public static ToolMaterial GOLD_CERTUSQUARTZ_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL, GOLD_BASE_USES + CERTUSQUARTZ_USES, GOLD_BASE_SPEED + CERTUSQUARTZ_SPEED, GOLD_BASE_DMG + CERTUSQUARTZ_DMG, GOLD_BASE_ENCH + CERTUSQUARTZ_ENCH, Tags.Items.INGOTS_GOLD);
    ...
    public static ToolMaterial GOLD_COBALT_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL, GOLD_BASE_USES + COBALT_USES, GOLD_BASE_SPEED + COBALT_SPEED, GOLD_BASE_DMG + COBALT_DMG, GOLD_BASE_ENCH + COBALT_ENCH, Tags.Items.INGOTS_GOLD);
    public static ToolMaterial GOLD_TITANIUM_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL, GOLD_BASE_USES + TITANIUM_USES, GOLD_BASE_SPEED + TITANIUM_SPEED, GOLD_BASE_DMG + TITANIUM_DMG, GOLD_BASE_ENCH + TITANIUM_ENCH, Tags.Items.INGOTS_GOLD);
    public static ToolMaterial GOLD_ZINC_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_GOLD_TOOL, GOLD_BASE_USES + ZINC_USES, GOLD_BASE_SPEED + ZINC_SPEED, GOLD_BASE_DMG + ZINC_DMG, GOLD_BASE_ENCH + ZINC_ENCH, Tags.Items.INGOTS_GOLD);
    ...
    public static ToolMaterial DIAMOND_BLAZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, DIAMOND_BASE_USES + BLAZE_USES, DIAMOND_BASE_SPEED + BLAZE_SPEED, DIAMOND_BASE_DMG + BLAZE_DMG, DIAMOND_BASE_ENCH + BLAZE_ENCH, Tags.Items.GEMS_DIAMOND);
    ...
    public static ToolMaterial DIAMOND_END_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, DIAMOND_BASE_USES + END_USES, DIAMOND_BASE_SPEED + END_SPEED, DIAMOND_BASE_DMG + END_DMG, DIAMOND_BASE_ENCH + END_ENCH, Tags.Items.GEMS_DIAMOND);
    ...
    public static ToolMaterial DIAMOND_BREEZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, DIAMOND_BASE_USES + BREEZE_USES, DIAMOND_BASE_SPEED + BREEZE_SPEED, DIAMOND_BASE_DMG + BREEZE_DMG, DIAMOND_BASE_ENCH + BREEZE_ENCH, Tags.Items.GEMS_DIAMOND);
    ...
    public static ToolMaterial DIAMOND_CERTUSQUARTZ_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, DIAMOND_BASE_USES + CERTUSQUARTZ_USES, DIAMOND_BASE_SPEED + CERTUSQUARTZ_SPEED, DIAMOND_BASE_DMG + CERTUSQUARTZ_DMG, DIAMOND_BASE_ENCH + CERTUSQUARTZ_ENCH, Tags.Items.GEMS_DIAMOND);
    ...
    public static ToolMaterial DIAMOND_COBALT_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, DIAMOND_BASE_USES + COBALT_USES, DIAMOND_BASE_SPEED + COBALT_SPEED, DIAMOND_BASE_DMG + COBALT_DMG, DIAMOND_BASE_ENCH + COBALT_ENCH, Tags.Items.GEMS_DIAMOND);
    public static ToolMaterial DIAMOND_TITANIUM_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, DIAMOND_BASE_USES + TITANIUM_USES, DIAMOND_BASE_SPEED + TITANIUM_SPEED, DIAMOND_BASE_DMG + TITANIUM_DMG, DIAMOND_BASE_ENCH + TITANIUM_ENCH, Tags.Items.GEMS_DIAMOND);
    public static ToolMaterial DIAMOND_ZINC_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, DIAMOND_BASE_USES + ZINC_USES, DIAMOND_BASE_SPEED + ZINC_SPEED, DIAMOND_BASE_DMG + ZINC_DMG, DIAMOND_BASE_ENCH + ZINC_ENCH, Tags.Items.GEMS_DIAMOND);
    ...
    public static ToolMaterial NETHERITE_BLAZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, NETHERITE_BASE_USES + BLAZE_USES, NETHERITE_BASE_SPEED + BLAZE_SPEED, NETHERITE_BASE_DMG + BLAZE_DMG, NETHERITE_BASE_ENCH + BLAZE_ENCH, Tags.Items.INGOTS_NETHERITE);
    ...
    public static ToolMaterial NETHERITE_END_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, NETHERITE_BASE_USES + END_USES, NETHERITE_BASE_SPEED + END_SPEED, NETHERITE_BASE_DMG + END_DMG, NETHERITE_BASE_ENCH + END_ENCH, Tags.Items.INGOTS_NETHERITE);
    ...
    public static ToolMaterial NETHERITE_BREEZE_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, NETHERITE_BASE_USES + BREEZE_USES, NETHERITE_BASE_SPEED + BREEZE_SPEED, NETHERITE_BASE_DMG + BREEZE_DMG, NETHERITE_BASE_ENCH + BREEZE_ENCH, Tags.Items.INGOTS_NETHERITE);
    ...
    public static ToolMaterial NETHERITE_CERTUSQUARTZ_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, NETHERITE_BASE_USES + CERTUSQUARTZ_USES, NETHERITE_BASE_SPEED + CERTUSQUARTZ_SPEED, NETHERITE_BASE_DMG + CERTUSQUARTZ_DMG, NETHERITE_BASE_ENCH + CERTUSQUARTZ_ENCH, Tags.Items.INGOTS_NETHERITE);
    ...
    public static ToolMaterial NETHERITE_COBALT_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, NETHERITE_BASE_USES + COBALT_USES, NETHERITE_BASE_SPEED + COBALT_SPEED, NETHERITE_BASE_DMG + COBALT_DMG, NETHERITE_BASE_ENCH + COBALT_ENCH, Tags.Items.INGOTS_NETHERITE);
    public static ToolMaterial NETHERITE_TITANIUM_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, NETHERITE_BASE_USES + TITANIUM_USES, NETHERITE_BASE_SPEED + TITANIUM_SPEED, NETHERITE_BASE_DMG + TITANIUM_DMG, NETHERITE_BASE_ENCH + TITANIUM_ENCH, Tags.Items.INGOTS_NETHERITE);
    public static ToolMaterial NETHERITE_ZINC_TM = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, NETHERITE_BASE_USES + ZINC_USES, NETHERITE_BASE_SPEED + ZINC_SPEED, NETHERITE_BASE_DMG + ZINC_DMG, NETHERITE_BASE_ENCH + ZINC_ENCH, Tags.Items.INGOTS_NETHERITE);
