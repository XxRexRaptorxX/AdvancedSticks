...
public class BlockWoodenBars extends Block {
...
/**	    public Item getItemDropped(IBlockState state, Random rand, int fortune)
	    ...
	    {
	        return blockIn.getDefaultState().isFullCube() || blockIn == this || blockIn == Blocks.GLASS || blockIn == Blocks.STAINED_GLASS || blockIn == Blocks.STAINED_GLASS_PANE || blockIn == ModBlocks.goldBars || blockIn instanceof BlockPane;
	    }
