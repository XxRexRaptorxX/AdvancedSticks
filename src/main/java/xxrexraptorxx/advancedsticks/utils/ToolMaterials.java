...
public class ToolMaterials {
    ...
    public static final ForgeTier WOOD_BONE_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + BONE_USES, WOOD_BASE_SPEED + BONE_SPEED, WOOD_BASE_DMG + BONE_DMG, WOOD_BASE_ENCH + BONE_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_COPPER_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + COPPER_USES, WOOD_BASE_SPEED + COPPER_SPEED, WOOD_BASE_DMG + COPPER_DMG, WOOD_BASE_ENCH + COPPER_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_ADVANCED_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + ADVANCED_USES, WOOD_BASE_SPEED + ADVANCED_SPEED, WOOD_BASE_DMG + ADVANCED_DMG, WOOD_BASE_ENCH + ADVANCED_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));
    
    public static final ForgeTier WOOD_ENCHANTED_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + ENCHANTED_USES, WOOD_BASE_SPEED + ENCHANTED_SPEED, WOOD_BASE_DMG + ENCHANTED_DMG, WOOD_BASE_ENCH + ENCHANTED_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_BLAZEROD_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + BLAZEROD_USES, WOOD_BASE_SPEED + BLAZEROD_SPEED, WOOD_BASE_DMG + BLAZEROD_DMG, WOOD_BASE_ENCH + BLAZEROD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_EMERALD_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + EMERALD_USES, WOOD_BASE_SPEED + EMERALD_SPEED, WOOD_BASE_DMG + EMERALD_DMG, WOOD_BASE_ENCH + EMERALD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_AMETHYST_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + AMETHYST_USES, WOOD_BASE_SPEED + AMETHYST_SPEED, WOOD_BASE_DMG + AMETHYST_DMG, WOOD_BASE_ENCH + AMETHYST_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_ENDROD_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + ENDROD_USES, WOOD_BASE_SPEED + ENDROD_SPEED, WOOD_BASE_DMG + ENDROD_DMG, WOOD_BASE_ENCH + ENDROD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_IRON_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + IRON_USES, WOOD_BASE_SPEED + IRON_SPEED, WOOD_BASE_DMG + IRON_DMG, WOOD_BASE_ENCH + IRON_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_GOLD_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + GOLD_USES, WOOD_BASE_SPEED + GOLD_SPEED, WOOD_BASE_DMG + GOLD_DMG, WOOD_BASE_ENCH + GOLD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_DIAMOND_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + DIAMOND_USES, WOOD_BASE_SPEED + DIAMOND_SPEED, WOOD_BASE_DMG + DIAMOND_DMG, WOOD_BASE_ENCH + DIAMOND_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));

    public static final ForgeTier WOOD_NETHERITE_TM = new ForgeTier(Tiers.WOOD.getLevel(), WOOD_BASE_USES + NETHERITE_USES, WOOD_BASE_SPEED + NETHERITE_SPEED, WOOD_BASE_DMG + NETHERITE_DMG, WOOD_BASE_ENCH + NETHERITE_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.PLANKS));


    public static final ForgeTier STONE_BONE_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + BONE_USES, STONE_BASE_SPEED + BONE_SPEED, STONE_BASE_DMG + BONE_DMG, STONE_BASE_ENCH + BONE_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_COPPER_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + COPPER_USES, STONE_BASE_SPEED + COPPER_SPEED, STONE_BASE_DMG + COPPER_DMG, STONE_BASE_ENCH + COPPER_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_ADVANCED_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + ADVANCED_USES, STONE_BASE_SPEED + ADVANCED_SPEED, STONE_BASE_DMG + ADVANCED_DMG, STONE_BASE_ENCH + ADVANCED_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_ENCHANTED_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + ENCHANTED_USES, STONE_BASE_SPEED + ENCHANTED_SPEED, STONE_BASE_DMG + ENCHANTED_DMG, STONE_BASE_ENCH + ENCHANTED_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_BLAZEROD_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + BLAZEROD_USES, STONE_BASE_SPEED + BLAZEROD_SPEED, STONE_BASE_DMG + BLAZEROD_DMG, STONE_BASE_ENCH + BLAZEROD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_EMERALD_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + EMERALD_USES, STONE_BASE_SPEED + EMERALD_SPEED, STONE_BASE_DMG + EMERALD_DMG, STONE_BASE_ENCH + EMERALD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_AMETHYST_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + AMETHYST_USES, STONE_BASE_SPEED + AMETHYST_SPEED, STONE_BASE_DMG + AMETHYST_DMG, STONE_BASE_ENCH + AMETHYST_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_ENDROD_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + ENDROD_USES, STONE_BASE_SPEED + ENDROD_SPEED, STONE_BASE_DMG + ENDROD_DMG, STONE_BASE_ENCH + ENDROD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_IRON_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + IRON_USES, STONE_BASE_SPEED + IRON_SPEED, STONE_BASE_DMG + IRON_DMG, STONE_BASE_ENCH + IRON_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_GOLD_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + GOLD_USES, STONE_BASE_SPEED + GOLD_SPEED, STONE_BASE_DMG + GOLD_DMG, STONE_BASE_ENCH + GOLD_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_DIAMOND_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + DIAMOND_USES, STONE_BASE_SPEED + DIAMOND_SPEED, STONE_BASE_DMG + DIAMOND_DMG, STONE_BASE_ENCH + DIAMOND_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));

    public static final ForgeTier STONE_NETHERITE_TM = new ForgeTier(Tiers.STONE.getLevel(), STONE_BASE_USES + NETHERITE_USES, STONE_BASE_SPEED + NETHERITE_SPEED, STONE_BASE_DMG + NETHERITE_DMG, STONE_BASE_ENCH + NETHERITE_ENCH, BlockTags.NEEDS_STONE_TOOL, () -> Ingredient.m_204132_(ItemTags.STONE_TOOL_MATERIALS));
